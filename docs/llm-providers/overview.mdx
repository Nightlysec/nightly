---
title: "Overview"
description: "Configure your AI model for Nightly"
---

Nightly uses [LiteLLM](https://docs.litellm.ai/docs/providers) for model compatibility, supporting 100+ LLM providers.
...
```bash
export NIGHTLY_LLM="ollama/llama4"
