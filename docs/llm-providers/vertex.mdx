...
description: "Configure Nightly with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install Nightly with the vertex extra:

```bash
pipx install "nightly-agent[vertex]"
```

## Setup

```bash
export NIGHTLY_LLM="vertex_ai/gemini-3-pro-preview"
```
