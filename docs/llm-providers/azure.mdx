---
title: "Azure OpenAI"
description: "Configure Nightly with OpenAI models via Azure"
---

## Setup

```bash
export NIGHTLY_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `NIGHTLY_LLM` | `azure/<your-deployment-name>` |
...
```bash
export NIGHTLY_LLM="azure/gpt-5.4-deployment"
