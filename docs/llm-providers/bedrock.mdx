---
title: "AWS Bedrock"
description: "Configure Nightly with models via AWS Bedrock"
---

## Installation

Bedrock requires the AWS SDK dependency. Install Nightly with the bedrock extra:

```bash
pipx install "nightly-agent[bedrock]"
```

## Setup

```bash
export NIGHTLY_LLM="bedrock/anthropic.claude-4-5-sonnet-20251022-v1:0"
```
