...
description: "Guide Nightly with custom testing instructions"
---
...
```bash
nightly --target https://app.com --instruction "Focus on authentication vulnerabilities"
```
...
```bash
nightly --target https://app.com --instruction-file ./pentest-instructions.md
```
...
```bash
nightly --target https://api.example.com \
...
<Tip>
Be specific. Good instructions help Nightly prioritize the most valuable attack paths.
</Tip>
