---
title: "Agent Tools"
description: "How Nightly agents interact with targets"
---

Nightly agents use specialized tools to test your applications like a real penetration tester would.
