---
title: "Contributing"
description: "Contribute to Nightly development"
---
...
Skills are specialized knowledge packages that enhance agent capabilities. They live in `nightly/skills/`
...
the sidecar as `nightly/bin/nightly-tui`, and assigns the current platform tag.
Frozen releases built by `scripts/build.sh` and `nightly.spec` also require the
sidecar.
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Issues" icon="github" href="https://github.com/usenightly/nightly/issues">
