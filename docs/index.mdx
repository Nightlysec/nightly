...
<Frame>
  <img src="/images/screenshot.png" alt="Nightly Demo" />
</Frame>
...
Nightly agents come equipped with a comprehensive toolkit:
...
Nightly uses a graph of specialized agents for comprehensive security testing:
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub" icon="github" href="https://github.com/nightlysec/nightly">
