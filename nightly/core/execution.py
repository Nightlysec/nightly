"""Execution loop for addressable SDK-backed Nightly agents."""
...
from nightly.core.hooks import (
    BudgetExceededError,
    BudgetPausedError,
    SubagentBudgetReservedError,
)
from nightly.core.inputs import child_initial_input
from nightly.core.sessions import (
...
from nightly.llm.compaction import is_context_overflow, maybe_compact
...
if TYPE_CHECKING:
    ...
    from nightly.core.agents import AgentCoordinator, Status
