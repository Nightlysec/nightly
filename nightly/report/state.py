...
from nightly.report.sarif import write_sarif
from nightly.report.usage import LLMUsageLedger
from nightly.report.writer import (
    read_run_record,
...
class ReportState:
    ...
    persistence. This store keeps only Nightly-owned scan artifacts and
...
class StreamedOpenRouterCosts:
    ...
    scan streams, so the OpenRouter streaming handler (see nightly.config.models)
