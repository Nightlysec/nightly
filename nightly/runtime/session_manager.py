...
from nightly.runtime.backends import backend_supports_bind_mounts, get_backend
from nightly.runtime.caido_bootstrap import bootstrap_caido
...
def _host_identity_env() -> dict[str, str]:
    ...
    return {"NIGHTLY_HOST_UID": str(os.getuid()), "NIGHTLY_HOST_GID": str(os.getgid())}
