...
const WIDTH_KEY = "nightly_viewer_sidebar_width";
const COLLAPSE_KEY = "nightly_viewer_sidebar_collapsed";
...
export default function Sidebar({
  ...
  return (
    <>
      ...
      >
        {/* Header — account-switcher stand-in (links out to Nightly Cloud). */}
            ...
            <div className="flex h-10 w-full flex-row items-center">
              ...
              >
                ...
                <span className="flex flex-1 flex-row items-center gap-2 min-w-0">
                  <span className="truncate min-w-0 text-[14px] font-medium text-[#ededed]">Nightly</span>
          ...
          <div className="relative flex flex-col gap-px px-2">
            ...
            <NavItem
              ...
              onClick={() =>
                openUpgrade(
                  "pr_reviews",
                  "Nightly reviews every pull request and flags exploitable changes before they merge."
                )
              }
            />
            <NavItem
