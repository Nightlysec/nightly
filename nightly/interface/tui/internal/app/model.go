...
// It is set by main from the NIGHTLY_VERSION env var (see go_tui.py), matching
// Python's get_package_version() which reads the installed "nightly-agent" version
...
const (
	...
	setupPlaceholderShort = "What should Nightly test?"
...
// splashTick drives the splash "Starting Nightly Agent" shimmer at Python's 0.1s cadence.
